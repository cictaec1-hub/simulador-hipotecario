...
const translations = {
    es: {
        ...
        "profile1-title": "🏦 MENOS DE 35 AÑOS<br>Financiación especial hasta 95%–100% para menores que compran su primera vivienda habitual.  (Aval Instituto crédito oficial (ICO))",
        "profile1-li1": "✅ Requisitos de Elegibilidad",
        "profile1-li2": "Ingresos: Máximo 37.800 € brutos/año (el límite sube si hay hijos a cargo).",
        "profile1-li3": "Patrimonio: Activos netos inferiores a 100.000 €.",
        "profile1-li4": "Residencia: Certificado de empadronamiento (mínimo 2 años en España).",
        "profile1-li5": "Propiedad: Certificado de no titularidad (debe ser tu primera vivienda).",
        "profile1-li6": "💼 Solvencia Financiera",
        "profile1-li7": "Contrato: Indefinido o estabilidad laboral demostrable.",
        "profile1-li8": "Ahorro: Debes disponer de aprox. el 10–12% del valor para impuestos y gastos (ITP, Notaría, Registro), ya que el préstamo cubre la casa, pero no los gastos.",
        "profile1-li9": "📄 Documentos Imprescindibles",
        "profile1-li10": "Personales: DNI/NIE, Vida Laboral y 3 últimas nóminas.",
        "profile1-li11": "Fiscales: Última declaración de la Renta (IRPF).",
        "profile1-li12": "🏠 Documentación del inmueble<br>Nota Simple actualizada (menos de 3 meses)",
    ...
    ca: {
        ...
        "profile1-title": "🏦 MENYS DE 35 ANYS<br>Finançament especial fins al 95%–100% per a menors que compren la seva primera vivenda habitual.  (Aval Institut de Crèdit Oficial (ICO))",
        "profile1-li1": "✅ Requisits d'Elegibilitat",
        "profile1-li2": "Ingressos: Màxim 37.800 € bruts/any (el límit puja si hi ha fills a càrrec).",
        "profile1-li3": "Patrimoni: Actius nets inferiors a 100.000 €.",
        "profile1-li4": "Residència: Certificat d'empadronament (mínim 2 anys a Espanya).",
        "profile1-li5": "Propietat: Certificat de no titularitat (ha de ser la teva primera vivenda).",
        "profile1-li6": "💼 Solvència Financera",
        "profile1-li7": "Contracte: Indefinit o estabilitat laboral demostrable.",
        "profile1-li8": "Estalvi: Has de disposar d'aprox. el 10–12% del valor per a impostos i despeses (ITP, Notaria, Registre), ja que el préstec cobreix la casa, però no les despeses.",
        "profile1-li9": "📄 Documents Imprescindibles",
        "profile1-li10": "Personals: DNI/NIE, Vida Laboral i 3 últimes nòmines.",
        "profile1-li11": "Fiscals: Última declaració de la Renda (IRPF).",
        "profile1-li12": "🏠 Documentació de l'immoble<br>Nota Simple actualitzada (menys de 3 mesos)",
    ...
    fr: {
        ...
        "profile1-title": "🏦 MOINS DE 35 ANS<br>Financement spécial jusqu'à 95%–100% pour les jeunes achetant leur première résidence principale. (Garantie Institut de Crédit Officiel (ICO))",
        "profile1-li1": "✅ Critères d'éligibilité",
        "profile1-li2": "Revenus : Maximum 37.800 € bruts/an (le plafond augmente si enfants à charge).",
        "profile1-li3": "Patrimoine : Actifs nets inférieurs à 100.000 €.",
        "profile1-li4": "Résidence : Certificat de résidence (minimum 2 ans en Espagne).",
        "profile1-li5": "Propriété : Certificat de non-propriété (doit être votre première résidence).",
        "profile1-li6": "💼 Solvabilité financière",
        "profile1-li7": "Contrat : CDI ou stabilité professionnelle démontrable.",
        "profile1-li8": "Épargne : Vous devez disposer d'environ 10–12% du montant pour impôts et frais (ITP, Notaire, Registre), le prêt couvre le logement mais pas les frais.",
        "profile1-li9": "📄 Documents indispensables",
        "profile1-li10": "Personnels : CNI/NIE, Attestation de carrière et 3 dernières fiches de paie.",
        "profile1-li11": "Fiscaux : Dernière déclaration d'impôt (IRPF).",
        "profile1-li12": "🏠 Documents du bien immobilier<br>Note Simple à jour (moins de 3 mois)",
            // ENGLISH TRANSLATION
            "profile1-title": "🏦 MOINS DE 35 ANS<br>Financement spécial jusqu'à 95%–100% pour les jeunes achetant leur première résidence principale. (Garantie Institut de Crédit Officiel (ICO))",
            "profile1-li1": "✅ Critères d'éligibilité",
            "profile1-li2": "Revenus : Maximum 37.800 € bruts/an (le plafond augmente si enfants à charge).",
